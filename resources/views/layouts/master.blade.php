...
<script type="text/javascript"
        src="{!! asset('assets/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js') !!}"></script>
...
<script type='text/javascript'
        src='{!! asset('assets/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') !!}'></script>
<script type='text/javascript'
        src='{!! asset('assets/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') !!}'></script>
